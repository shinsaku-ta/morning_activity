...
ActiveRecord::Schema.define(version: 2019_12_24_072550) do
  ...
  create_table "morning_activity_results", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.datetime "execution_at"
    t.integer "state"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_morning_activity_results_on_user_id"
  end
  ...
  add_foreign_key "morning_activity_results", "users"
end
